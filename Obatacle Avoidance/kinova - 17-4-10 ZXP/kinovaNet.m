...
[J,JJ,JJJ] = JacobN(q,lenK);   %ZXP J,JJ为3x6矩阵 J=>A JJ=>AA
[JN,distob,sdjt,effective_oan,dis]=JObstacleN(q,qDot);
% ZXP JN=>Jo JN为3*oan x6矩阵 即18x6
...
doty=[qDot;uDot];   %ZXP y(1:6)为给qDot积分；y(7:33)为uDot神经网络（？）