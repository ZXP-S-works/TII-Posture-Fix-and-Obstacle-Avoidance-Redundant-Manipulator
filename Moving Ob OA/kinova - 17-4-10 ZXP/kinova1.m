...
% D= [0.2755, 0.4100, 0.2073, 0.0743, 0.0743, 0.1687, 0.0098]; %D1~D6;E2 %ZXP corrected by ZXP in Mar 1
...
%ZXP
%D= [0.2755, 0.4100, 0.2073, 0.0741, 0.0741, 0.1425, 0.0098]; %D1~D6;E2 %ZXP corrected by ZXP in Mar 1
D= [0.2755, 0.4100, 0.2073, 0.0741, 0.0741, 0.1425, 0.0098]; %D1~D6;E2 %ZXP corrected by ZXP in Mar 1
%aaa = 11.0*pi/72;
aaa = pi*(60/360);
ca = cos(aaa);
...
[t,y]=ode15s('kinovaNet',[0,10],init);%ode15s much better than ode15s%解刚性微分方程（J
